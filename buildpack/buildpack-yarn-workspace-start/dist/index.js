...
class YarnWorkspaceStartBuilder {
    async build(ctx) {
        ...
        const entrypoint = ((_a = entry === null || entry === void 0 ? void 0 : entry.metadata) === null || _a === void 0 ? void 0 : _a.entrypoint) || 'dist/index.js';
...
class YarnWorkspaceStartDetector {
    async detect(ctx) {
        ...
        const { stdout } = await execa_default()('yarn', ['workspaces', 'list', '--json']);
